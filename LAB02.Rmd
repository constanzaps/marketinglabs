...
Casas1 <- Casas[c("Sale_Price","Lot_Area","Year_Built","Total_Bsmt_SF","Central_Air",
                  "Gr_Liv_Area","Heating_QC", "Kitchen_AbvGr","TotRms_AbvGrd","Fireplaces")]
...
Model1 <- lm(Sale_Price ~ Lot_Area+Overall_Cond+Year_Built+Total_Bsmt_SF+Central_Air+
                  Foundation+Gr_Liv_Area+Heating_QC+Kitchen_AbvGr+TotRms_AbvGrd+Fireplaces, data=Casas1)
# creamos la regresion
summary(Model1) # vemos el output de la regresion

Model2 <- lm(Sale_Price ~ Lot_Area+Year_Built+Total_Bsmt_SF+Central_Air+
                  Gr_Liv_Area+Heating_QC+Kitchen_AbvGr+TotRms_AbvGrd+Fireplaces, data=Casas1)
# creamos la regresion
summary(Model1) # vemos el output de la regresion
