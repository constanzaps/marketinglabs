...
index <- sample(1:nrow(anime), size=round(0.8*nrow(anime),0))
...
```{r}
modelo2<-mlogit(Eleccion ~ NEscenasCombate + NescenasEmocionantes + CalidadAnimacion+ RatingTV| Edad + Mujer | 0, data = myftrain, print.level=1) #La wea no cambia nada si quitar 
summary(modelo2)
```
