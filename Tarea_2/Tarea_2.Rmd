...
```{r}
modelo1<-mlogit(Eleccion ~ NEscenasCombate + NescenasEmocionantes + CalidadAnimacion+ RatingTV+NescenasEmocionantes*RatingTV| 1 | 0, data = myf, print.level=1) #La wea no cambia nada si quitar 
...
```{r}
modelo2<-mlogit(Eleccion ~ NEscenasCombate + NescenasEmocionantes + CalidadAnimacion+ RatingTV| 1 | 0, data = myf, print.level=1) #La wea no cambia nada si quitar 
...
```{r}
cat("mixed logit without correlation\n")
summary(model_mxlogit.v1)
rpar(model_mxlogit.v1)

cat("mixed logit with correlation\n")
...
Probit con mlogit
```{r}
modelo_probit<-mlogit(Eleccion ~ NEscenasCombate + NescenasEmocionantes + CalidadAnimacion+ RatingTV| 1 | 0, data = myf, probit = TRUE, print.level=1) 
