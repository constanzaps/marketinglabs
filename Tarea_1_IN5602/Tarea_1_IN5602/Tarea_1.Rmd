...
Con ello se puede observar que todas estas categorías están repartidas con igual porcentaje dentro de la base de datos. Otro dato interesante es que cada marca se encuentra en una ciudad distinta, por lo cual bastará con estudiar solo una de las dos variables.
...
Luego se puede realizar un análisis de las variables categóricas, donde se puede observar que si existen leves diferencias en las distribuciones de rating, notandose un poco más en las variables  *Product.line* y según género.
