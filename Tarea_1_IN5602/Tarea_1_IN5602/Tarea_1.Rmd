...
PArámetro principla, lo que va ajustando, es cuantas variables explictivas le debo pasar al modelo para que se calibre bien
...
train.randomf <- train(Rating ~ Branch + Gender + Product.line 
                   + Payment +Customer.type+ Gender*Payment + Customer.type*Product.line + Total + Time
                   + Product.line*Total + Product.line*Weekday+ Branch*Gender+ Product.line*Payment +
                     dia*Payment,
...
train.knn <- train(Rating ~ Branch + Gender + Product.line 
                   + Payment +Customer.type+ Gender*Payment + Customer.type*Product.line + Total + Time
                   + Product.line*Total + Product.line*Weekday+ Branch*Gender+
                     dia*Payment, #+ Product.line*Payment si agreggo esto son 13
