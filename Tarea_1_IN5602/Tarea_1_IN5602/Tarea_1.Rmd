...
```{r, fig.width=14, fig.height=8, dpi=300, echo=FALSE}
...
train.randomf <- train(Rating ~ City + Total + Time  + Product.line 
...
train.knn <- train(Rating ~ City + Total + Time  + Product.line 
