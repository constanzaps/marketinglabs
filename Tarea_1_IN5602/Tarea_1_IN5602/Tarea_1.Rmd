...
g2 <-ggplot(ventas, aes(x=Rating, fill=factor(Payment))) + geom_density(alpha=0.4) + facet_grid(dia~ Payment) +theme(legend.position = "none")
g2
```
...
g
```
Con esta interacción se puede observar que el rating cambia al realizar la interacción ciudad y género.
...
productline*city
city*gender
porbar product line x city

#### Modelo Random Forest

En base a lo observado en la P2, se escogen las variables City, Total, Product.line, Payment, Gender y la interacción de City con Gender


Para que este modelo calibre bien deben usarse 2 variables explicativas.
```{r p2rf}
### Ejecutar Random Forest
train.randomf <- train(Rating ~ City + Total + Time + Gender + Product.line 
                   + Payment +Customer.type+ Gender*Payment + City*Gender,
...
train.knn <- train(Rating ~ City + Total + Time + Gender + Product.line 
                   + Payment +Customer.type+ Gender*Payment + City*Gender, #+ Product.line*Payment si agreggo esto son 13
